...
contract Dao {
    ...
    constructor() {
        owner = msg.sender;
        nextProposal = 1;
        daoContract = IdaoContract(0x000);
        validTokens = [234455555];
    }
    ...
    function createProposal(string memory _description, address[] memory _canVote) public {
        require(checkProposalEligibility(msg.sender), "only if you have nft you can vote");
    ...
    function voteOnProposal(uint256 _id, bool _vote) public {
        require(Proposals[_id].exists, "proposal doesn t exist");
    ...
    function countVotes(uint256 _id) public {
        ...
        require(Proposals[_id].exists, "this thing doesn t exist");
        require(block.number > Proposals[_id].deadline, "deadline is still not reached");
        require(!Proposals[_id].countConducted, "you already counted");
